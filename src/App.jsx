...
background: i < input.length ? accentColor : “rgba(255,255,255,0.15)”,
border: `1.5px solid ${i < input.length ? accentColor : "rgba(255,255,255,0.2)"}`,
transition: “background 0.15s, border 0.15s”,
transform: i < input.length ? “scale(1.15)” : “scale(1)”,
boxShadow: i < input.length ? `0 0 8px ${accentColor}55` : “none”,
}} />
))}
</div>
